...
public class StockDaoImplTest extends TestCase {
    ...
    public void testSelectStkAll() throws Exception {
        ...
        assertFalse(stockDao.insertStk(stockDto)==1);   /*isDuplicateStock 으로 중복검사 코드 추가*/
        assertTrue(stockDao.count()==1);
        assertTrue(stockDao.selectStkAll().size()==1);
        ...
        for(int i = 1; i <= 3; i++){
            for(int j = 1; j <= 3 ; j++){
                StockDto stockDto2 = new StockDto(String.valueOf(j), "M"+i, 10, 0, 2, 2, 1, "20240325", "20240327", "저기야구용품", 40000, 50000, 50000, "4A", "00");
        ...
        for(int i = 1; i <= 3; i++){
            for(int j = 1; j <= 3333 ; j++){
                StockDto stockDto3 = new StockDto(String.format("%04d", j), "M"+i, 10, 0, 2, 2, 1, "20240325", "20240327", "저기야구용품", 40000, 50000, 50000, "4A", "00");
    ...
    public void testSelectStk() throws Exception {
        ...
        for(int i = 1; i <= 3; i++){
            for(int j = 1; j <= 3 ; j++){
                StockDto stockDto3 = new StockDto(String.valueOf(j), "M"+i, 10, 0, 2, 2, 1, "20240325", "20240327", "저기야구용품", 40000, 50000, 50000, "4A", "00");
                stockDao.insertStk(stockDto3);
            }
        }
        /*3.1. 총 9개 삽입 됐는지 확인*/
        ...
        assertTrue(test1.getPd_id().equals("1") && test1.getPd_clsf_cd().equals("M1"));
        assertTrue(test2.getPd_id().equals("1") && test2.getPd_clsf_cd().equals("M2"));
        assertTrue(test3.getPd_id().equals("1") && test3.getPd_clsf_cd().equals("M3"));
    }
    ...
    public void testInsert() throws Exception {
        ...
        StockDto stockDto4 = new StockDto(null, "M", 10, 0, 2, 2, 1, "20240325", "20240327", "저기야구용품", 40000, 50000, 50000, "4A", "00");
        assertFalse(stockDao.insertStk(stockDto4) == 1);
    }
    ...
    public void testUpdate() throws Exception {
        ...
        /*2. 첫 삽입 데이터와 다른데이터 삽입: / count = 2 확인 */
        stockDto = new StockDto("APP000001-10", "L", 10, 0, 2, 2, 1, "20240325", "20240327", "저기야구용품", 40000, 50000, 50000, "4A", "00");
        assertTrue(stockDao.insertStk(stockDto)==1);
        assertTrue(stockDao.count()==2);
        
        /*3. 첫번째 재고 가용수량 update 후 데이터 바뀌었는지 확인*/
    }
