...
public class CartDaoImplTest {
    ...
    public void countTest() throws Exception{
        ...
        CartDto cart = new CartDto(c_id, "GLV000021-20", "RRR", 2, "img", "pd_name", 0, 0);
    ...
    public void deleteTest() throws Exception{
        ...
        int c_id = cartDao.getcustAll().get(0).getC_id();
        CartDto cart = new CartDto(c_id, "GLV000021-20", "RRR", 1, "img", "pd_name",0, 0);
        assertTrue(cartDao.insert(cart)==1);
        assertTrue(cartDao.count()==1);
    ...
    public void cidDeleteAll() throws Exception {
        ...
        int c_id = cartDao.getcustAll().get(0).getC_id();
        CartDto cart = new CartDto(c_id, "GLV000021-21", "RRR",1,"img", "pd_name",0, 0);
        CartDto cart2 = new CartDto(c_id, "GLV000022-21", "RR",1,"img", "pd_name",0, 0);
        assertTrue(cartDao.insert(cart)==1);
        assertTrue(cartDao.insert(cart2)==1);

        /* 1번고객이 장바구니에 1개추가 총 count는 3개 */
        int c_id2 = cartDao.getcustAll().get(1).getC_id();
        CartDto cart3 = new CartDto(c_id2, "GLV000021-21", "RR",1,"img", "pd_name",0, 0);
    ...
    public void insertTest() throws Exception {
        ...
        cart = new CartDto(c_id, "GLV000021-20", "RRR",2,"img", "pd_name",0, 0);
        assertTrue(cartDao.insert(cart)==1);
        assertTrue(cartDao.count()==2);
        ...
        cart = new CartDto(c_id, "GLV000021-20", "RRR",1,"img", "pd_name",0, 0);
        assertTrue(cartDao.insert(cart)==1);
        assertTrue(cartDao.count()==1);
    }
    ...
    public void selectUserTest() throws Exception {
        ...
        CartDto cart = new CartDto(cid, "GLV000021-30", "333",2,"img", "pd_name",0, 0);
        assertTrue(cartDao.insert(cart)==1);

        /* 1번째고객이 장바구니에 물건을 담는다 */
        int cid2 = cartDao.getcustAll().get(1).getC_id();
        CartDto cart2 = new CartDto(cid2, "GLV000021-30", "333",2,"img", "pd_name",0, 0);
    ...
    public void cartCheckTest() throws Exception {
        ...
        /* 0번째고객이 장바구니에 물건을 담는다 */
        CartDto cart = new CartDto(100003, "GLV000021-30", "S",2,"img", "pd_name",0, 0);
        CartDto cart2 = new CartDto(100003, "GLV000021-30", "S",2,"img", "pd_name",0, 0);
        CartDto cart3 = new CartDto(100003, "GLV000021-21", "M",1,"img","pd_name",0,0);
        assertTrue(cartDao.insert(cart)==1);
        assertTrue(cartDao.insert(cart2)==1);
        assertTrue(cartDao.insert(cart3)==1);
        assertTrue(cartDao.count()==3);
