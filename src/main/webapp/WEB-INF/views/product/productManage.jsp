...
<div id="main">
    ...
    <script>
        ...
        function exposureSettingWindow() {
            /*폼을 동적으로 생성한다.*/
            let form = $('<form id="popupForm" action="<c:url value='/product/manage/exposure'/>" method="post"></form>');
        ...
        function basicInformationWindow() {
            /*폼을 동적으로 생성한다.*/
            let form = $('<form id="popupForm" action="<c:url value='/product/manage/basicInformation'/>" method="post"></form>');
        ...
        function salesInformationWindow() {
            /*폼을 동적으로 생성한다.*/
            let form = $('<form id="popupForm" action="<c:url value='/product/manage/salesInformation'/>" method="post"></form>');
        ...
        function imageRegistrationWindow() {
            /*폼을 동적으로 생성한다.*/
            let form = $('<form id="popupForm" action="<c:url value='/product/manage/imageRegistration'/>" method="post"></form>');
        ...
        function makeForm() {
            /*폼을 동적으로 생성한다.*/
            let form = $('<form id="popupForm" action="<c:url value='/product/manage'/>" method="post"></form>');
