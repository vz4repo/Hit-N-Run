...
<div class="w3-sidebar w3-light-grey w3-bar-block w3-card w3-animate-left" style="display:none" id="mySidebar">
    <a href="<c:url value='/main'/>" class="w3-bar-item w3-button no-event"><img src="/img/homerunball_logo.png" style="width:100%"></a>
<%--    <a href="<c:url value='/main/#'/>" class="w3-bar-item w3-button">홈</a>--%>
    <a href="<c:url value='/product/dashboard'/>" class="w3-bar-item w3-button">대시보드</a>
    <a href="<c:url value='/product/list'/>" class="w3-bar-item w3-button">제품목록</a>
    <a href="<c:url value='/product/register'/>" class="w3-bar-item w3-button">제품등록</a>
    ...
    <div id="demoAcc1" class="w3-hide w3-white">
        <a href="<c:url value='/product/manage'/>" class="w3-bar-item w3-button">제품 정보 일괄 변경</a>
        <a href="<c:url value='/product/showHiddenProductList'/>" class="w3-bar-item w3-button">진열 제외 제품 목록</a>
    </div>
    ...
    <div id="demoAcc2" class="w3-hide w3-white">
        ...
        <a href="<c:url value='/stock/list'/>" class="w3-bar-item w3-button">재고등록/수정</a>
    </div>
    ...
    <div id="demoAcc3" class="w3-hide w3-white">
        <a href="<c:url value='/main/#'/>" class="w3-bar-item w3-button">주문 대시보드</a>
        <a href="<c:url value='/main/#'/>" class="w3-bar-item w3-button">전체주문조회</a>
        <a href="<c:url value='/main/#'/>" class="w3-bar-item w3-button">입금전 관리</a>
        <a href="<c:url value='/main/#'/>" class="w3-bar-item w3-button">배송 관리</a>
        <a href="<c:url value='/main/#'/>" class="w3-bar-item w3-button">취소/교환/반품/환불</a>
    </div>
    ...
    <div id="demoAcc4" class="w3-hide w3-white">
        <a href="<c:url value='/main/#'/>" class="w3-bar-item w3-button">회원 정보 조회</a>
        <a href="<c:url value='/main/#'/>" class="w3-bar-item w3-button">회원 등급별 관리</a>
        <a href="<c:url value='/main/#'/>" class="w3-bar-item w3-button">회원 탈퇴 관리</a>
        <a href="<c:url value='/main/#'/>" class="w3-bar-item w3-button">휴먼 회원 관리</a>
    </div>
